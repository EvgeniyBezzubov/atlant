...
def monitor_inactivity():
    ...
    all_gpio_pins = [GPIO10, GPIO07, GPIO08, GPIO15, GPIO4, GPIO17, GPIO27,
                     GPIO22, GPIO5, GPIO6, GPIO13, GPIO19, GPIO26, GPIO18,
                     GPIO23, GPIO24, GPIO25, GPIO12, GPIO16, GPIO21, GPIO14,
