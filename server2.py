...
def relle2pos(arg):
    if arg == 1:
        ...
        GPIO.output(GPIO2, GPIO.LOW) #bistriy dvagatel 1 
        GPIO.output(GPIO14, GPIO.HIGH) #medlenniy dvigatel 1
        
    elif arg == 0:
        GPIO.output(GPIO2, GPIO.HIGH) #bistriy dvagatel 1 
        GPIO.output(GPIO14, GPIO.LOW) #medlenniy dvigatel 1
    elif arg == 2:
        print(1)
        GPIO.output(GPIO2, GPIO.HIGH) #bistriy dvagatel 1 
        GPIO.output(GPIO14, GPIO.HIGH) #medlenniy dvigatel 1
